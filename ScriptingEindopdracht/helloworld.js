...
class Question {
    ...
    time;
    answers;
    constructor(question, time, answers = []) {
...
class MultipleChoiceQuestion extends Question {
    correctAnswer;
    constructor(question, time, answers, correctAnswer) {
...
class OpenQuestion extends Question {
    correctAnswer;
    constructor(question, time, correctAnswer) {
        super(question, time, []);
        this.correctAnswer = correctAnswer;
    }
    Antwoord(answer) {
...
for (let i = 0; i < quiz.questions.length; i++) {
    ...
    if (vragenType.type == "MULTIPLECHOICE") {
        let vraag = new MultipleChoiceQuestion(vragenType.question, vragenType.time, vragenType.answers, vragenType.correctAnswer);
        vragen.push(vraag);
    }
    if (vragenType.type == "Open") {
        let vraag = new OpenQuestion(vragenType.question, vragenType.time, vragenType.answers[0]);
        vragen.push(vraag);
    }
}
function showIntro() {
